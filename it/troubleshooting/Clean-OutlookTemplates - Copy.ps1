...
function Find-OutlookTemplates {
    Write-Log "Searching for Outlook template files..." "INFO"
...
function Clean-Template {
    ...
    try {
        ...
        # Form Feed (U+000C), Vertical Tab (U+000B), and other control characters
        $controlChars = @(
