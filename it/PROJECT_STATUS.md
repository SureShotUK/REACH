...
- **Boot ordering fix**: `docker-gpu-containers.service` systemd unit created and enabled — polls `nvidia-smi` before starting open-webui, comfyui, comfyui-amelia; documented in `NewPC/WaitOnNvidiaBootForDockerContainers.md`
